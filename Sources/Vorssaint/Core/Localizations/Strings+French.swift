...
extension Strings {
    static let fr = Strings(
        ...
        dockPreviewMediaControls: "Afficher les commandes multimédia des apps en lecture",
        dockPreviewMediaControlsCaption: "Au survol d’une app en lecture, affiche la pochette, les détails du morceau et les commandes avec les miniatures de fenêtres.",
