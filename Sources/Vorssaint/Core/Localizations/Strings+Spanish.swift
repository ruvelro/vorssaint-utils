...
extension Strings {
    static let es = Strings(
        ...
        dockPreviewMediaControls: "Mostrar controles multimedia para apps en reproducción",
        dockPreviewMediaControlsCaption: "Al pasar sobre una app en reproducción, muestra carátula, detalles de la pista y controles junto a las miniaturas de ventanas.",
