...
extension Strings {
    static let de = Strings(
        ...
        dockPreviewMediaControls: "Mediensteuerung für wiedergebende Apps anzeigen",
        dockPreviewMediaControlsCaption: "Beim Zeigen auf eine wiedergebende App werden Cover, Titelinfos und Wiedergabesteuerung neben den Fensterminiaturen angezeigt.",
