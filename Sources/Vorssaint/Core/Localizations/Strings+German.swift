...
extension Strings {
    static let de = Strings(
        ...
        dockPreviewBackgroundOpacity: "Deckkraft des Vorschauhintergrunds",
        dockPreviewBackgroundOpacityCaption: "Niedrigere Werte machen den Panelhintergrund transparenter, ohne Miniaturen oder Bedienelemente abzublenden.",
