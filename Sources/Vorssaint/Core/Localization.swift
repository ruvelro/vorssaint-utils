...
extension Strings {
    static let ptBR = Strings(
        ...
        dockPreviewBackgroundOpacity: "Opacidade do fundo dos previews",
        dockPreviewBackgroundOpacityCaption: "Valores menores deixam o fundo do painel mais transparente sem apagar miniaturas nem controles.",
